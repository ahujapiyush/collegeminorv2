...
function Profile() {
    return (
        ...
        <Sidebar/>
            ...
            <div className="container customspacing" style={{display : "flex" , margin:"10%" , width:"90%"}}>
		...
		<div className="row gutters">
			...
			<div className="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
				<div className="form-group">
					...
					<input type="url" className="form-control" id="Semester number" placeholder="Ex: 6"/>
				</div>
			</div>
		</div>
		<div className="row gutters">
		...
		<div className="row gutters">
			<div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				<div className="text-right">
					...
					<br /><br /><button type="button" id="submit" name="submit" className="btn btn-primary">Update</button>
				</div>
			</div>
		</div>
	</div>
